  ...
  policy = jsonencode({
    ...
    "Statement" : [
      ...
      },
      {
        ...
        "Condition" : {
          "StringEqualsIfExists" : {
            "ec2:vpc" : "arn:${local.computed_aws_partition}:ec2:${var.region}:${var.aws_account_id}:vpc/${var.custom_vpc_id != null ? var.custom_vpc_id : module.vpc.vpc_id}"
          }
        }
      },
      {
      ...
      },
      {
        ...
        "Resource" : "arn:${local.computed_aws_partition}:ec2:${var.region}:${var.aws_account_id}:security-group/${var.custom_sg_id != null ? var.custom_sg_id : aws_security_group.sg.id}",
        "Condition" : {
          "StringEquals" : {
            "ec2:vpc" : "arn:${local.computed_aws_partition}:ec2:${var.region}:${var.aws_account_id}:vpc/${var.custom_vpc_id != null ? var.custom_vpc_id : module.vpc.vpc_id}"
          }
